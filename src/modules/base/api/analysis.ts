...
export function collectionOrderNum(): Promise<ResponseStruct<countVo>> {
  return useHttp().get("/tenant/analysis/weekOrder/collection_order_num");
}

export function disbursementOrderNum(): Promise<ResponseStruct<countVo>> {
  return useHttp().get("/tenant/analysis/weekOrder/disbursement_order_num");
}

export function disbursementSuccessfulNum(): Promise<ResponseStruct<countVo>> {
  return useHttp().get("/tenant/analysis/weekOrder/disbursement_successful_num");
}

export function collectionSuccessfulNum(): Promise<ResponseStruct<countVo>> {
  return useHttp().get("/tenant/analysis/weekOrder/collection_successful_num");
}

export function collectionSuccessfulAmount(): Promise<ResponseStruct<countVo>> {
  return useHttp().get(
    "/tenant/analysis/weekOrder/collection_successful_amount"
  );
}
...
> {
  return useHttp().get(
    "/tenant/analysis/weekOrder/disbursement_successful_amount"
  );
}

export function collectionSuccessfulRate(): Promise<ResponseStruct<countVo>> {
  return useHttp().get("/tenant/analysis/weekOrder/collection_successful_rate");
}

export function disbursementSuccessfulRate(): Promise<ResponseStruct<countVo>> {
  return useHttp().get(
    "/tenant/analysis/weekOrder/disbursement_successful_rate"
  );
}
...
> {
  return useHttp().get("/tenant/analysis/successOrder/hourToday");
}

export function successOrderHourYesterday(): Promise<
  ResponseStruct<contentPeriodVo>
> {
  return useHttp().get("/tenant/analysis/successOrder/hourYesterday");
}
