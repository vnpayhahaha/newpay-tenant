...
// 银行账户查询
export function page(params: BankAccountVo): Promise<ResponseStruct<BankAccountVo[]>> {
...
// 银行账户编辑
export function save(id: number, data: BankAccountVo): Promise<ResponseStruct<null>> {
...
export function realDelete(ids: number[]): Promise<ResponseStruct<null>> {
  return useHttp().delete('/admin/channel/bank_account/real_delete', { data: ids })
}
