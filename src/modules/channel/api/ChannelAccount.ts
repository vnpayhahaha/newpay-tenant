...
// 渠道账户查询
export function page(params: ChannelAccountVo): Promise<ResponseStruct<ChannelAccountVo[]>> {
...
// 渠道账户编辑
export function save(id: number, data: ChannelAccountVo): Promise<ResponseStruct<null>> {
...
export function realDelete(ids: number[]): Promise<ResponseStruct<null>> {
  return useHttp().delete('/admin/channel/channel_account/real_delete', { data: ids })
}
