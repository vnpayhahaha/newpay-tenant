...
import { deleteByIds, page } from '~/channel/api/ChannelAccountDailyStats.ts'
...
defineOptions({ name: 'channel:channel_account_daily_stats' })
...
const options = ref<MaProTableOptions>({
  ...
  header: {
    mainTitle: () => t('ChannelAccountDailyStats.index'),
  },
  // 表格参数
  tableOptions: {
    on: {
