...
import { deleteByIds, page } from '~/channel/api/ChannelCallbackRecord.ts'
...
defineOptions({ name: 'channel:channel_callback_record' })
...
const options = ref<MaProTableOptions>({
  ...
  header: {
    mainTitle: () => t('channel_callback_record.index'),
  },
  // 表格参数
  tableOptions: {
    on: {
