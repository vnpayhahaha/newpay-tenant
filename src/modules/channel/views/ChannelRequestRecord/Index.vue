...
import { deleteByIds, page } from '~/channel/api/ChannelRequestRecord.ts'
...
defineOptions({ name: 'channel:channel_request_record' })
...
const options = ref<MaProTableOptions>({
  ...
  header: {
    mainTitle: () => t('channel_request_record.index'),
  },
  // 表格参数
  tableOptions: {
    on: {
