...
// 租户账户查询
export function page(params: TenantAccountVo): Promise<ResponseStruct<TenantAccountVo[]>> {
...
// 租户账户编辑
export function save(id: number, data: TenantAccountVo): Promise<ResponseStruct<null>> {
