...
// 付款订单编辑
export function save(id: number, data: DisbursementOrderVo): Promise<ResponseStruct<null>> {
  return useHttp().put(`/tenant/transaction/disbursement_order/${id}`, data)
}

// 付款订单删除
export function deleteByIds(ids: number[]): Promise<ResponseStruct<null>> {
  return useHttp().delete('/tenant/transaction/disbursement_order', { data: ids })
}
