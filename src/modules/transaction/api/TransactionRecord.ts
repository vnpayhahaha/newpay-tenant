...
// 交易管理查询
export function page(params: TransactionRecordVo): Promise<ResponseStruct<TransactionRecordVo[]>> {
  return useHttp().get('/admin/transaction/transaction_record/list', { params })
}

// 交易管理新增
export function create(data: TransactionRecordVo): Promise<ResponseStruct<null>> {
  return useHttp().post('/admin/transaction/transaction_record', data)
}

// 交易管理编辑
export function save(id: number, data: TransactionRecordVo): Promise<ResponseStruct<null>> {
  return useHttp().put(`/admin/transaction/transaction_record/${id}`, data)
}

// 交易管理删除
export function deleteByIds(ids: number[]): Promise<ResponseStruct<null>> {
  return useHttp().delete('/admin/transaction/transaction_record', { data: ids })
}
